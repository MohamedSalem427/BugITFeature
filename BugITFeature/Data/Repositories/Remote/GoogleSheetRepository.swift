...
class GoogleSheetRepository: GoogleSheetRepositoryProtocol {
    ...
    private func createSheetIfNotExists(spreadsheetId: String,
                                        sheetName: String) async throws {
